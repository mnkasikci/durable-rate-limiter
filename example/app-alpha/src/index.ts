// drl-example-alpha — one of two independently-deployed apps that share the
// upstream quota through the shared limiter. It is identical in shape to
// app-bravo and shares nothing with it but `example/shared/protocol.ts`.
//
...
/** This app's identity. app-bravo differs only here and in its worker name. */
const APP: DemoApp = 'alpha';
